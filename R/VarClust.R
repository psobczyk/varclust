...
#' If user knows the number of clusters one might use function \code{\link{MPCV.reps}},
#' which takes number of clusters as a parameter. For \code{\link{MPCV.reps}} one might 
