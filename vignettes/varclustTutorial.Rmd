...
what we expect to see is the separation of RNA and expression groups, not the homogeneity
within those groups. If we define different partition based on mlcc.fit we're getting 
...
In that case you can also compare segmentation in terms of misclassification.
```{r, warning=FALSE}
