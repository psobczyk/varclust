...
To estimate number of clusters one should use function **estim.ncp**.
One can select:

* minimal number of PCs (*ncp.min*)
* maximal number of PCs (*ncp.max*)
* one of four methods penLik, RajanPen, minkaBIC, minkaLaplace

```{r, echo=TRUE}
estim.ncp(comp[,benchmarkClustering==1], 1, 10)
```
